...
<body class="flex flex-col justify-center items-center bg-gray-200 md:mx-10 md:text-xl lg:text-base">
    <div class="flex flex-col w-full  lg:w-1/2 ">
        ...
        <div class="bg-sky-700">
            ...
            <a href="/content{{$user->id}}" class="text-white px-4 ">Accueil</a>
                <a href="/profil{{$user->id}}" class="text-white  px-4">Profil</a>
                <a href="/publications{{$user->id}}" class="text-white  px-4">Publications</a>
                <a href="/users{{$user->id}}" class="text-white  px-4">Users</a>
            </div>
        </div> 
        ...
        <div class="bg-gray-100 text-sm md:text-xl lg:text-sm">
            ...
            <div class="flex flex-row justify-between">
                ...
                <form action="/logout" method="POST" class="flex flex-col items-center justify-center mx-4">
                @csrf
